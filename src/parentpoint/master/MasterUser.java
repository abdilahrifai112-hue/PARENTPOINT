...
public class MasterUser extends JFrame {
    ...
    private void styleComponents() {
        ...
        jPanelFieldUsername.setBackground(DesignUtil.BG_CARD);
        jPanelFieldPassword.setBackground(DesignUtil.BG_CARD);
        jPanelFieldRole.setBackground(DesignUtil.BG_CARD);
        ...
        jLabelUsername.setFont(new Font("Segoe UI", Font.BOLD, 12));
        jLabelUsername.setForeground(DesignUtil.TEXT_PRIMARY);
        jLabelPassword.setFont(new Font("Segoe UI", Font.BOLD, 12));
        jLabelPassword.setForeground(DesignUtil.TEXT_PRIMARY);
        jLabelRole.setFont(new Font("Segoe UI", Font.BOLD, 12));
        jLabelRole.setForeground(DesignUtil.TEXT_PRIMARY);
        ...
        cbRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"admin", "guru", "orang_tua"}));
        ...
        jTable1.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting() && jTable1.getSelectedRow() >= 0) {
                ...
                tfUsername.setText(jTable1.getValueAt(row, 1).toString());
                tfPassword.setText("");
                String role = jTable1.getValueAt(row, 2).toString();
                for (int i = 0; i < cbRole.getItemCount(); i++) {
                    if (cbRole.getItemAt(i).equals(role)) {
...
// setSize removed for responsiveness
    ...
    private void loadData() {
        ...
        if (conn != null) {
            try {
                ...
                if ("guru".equalsIgnoreCase(parentpoint.util.Session.getRole())) {
                    sql += "WHERE username = '" + parentpoint.util.Session.getUsername() + "' ";
                }
                sql += "ORDER BY id";
    ...
    private void simpan() {
        if (tfUsername.getText().trim().isEmpty() || new String(tfPassword.getPassword()).isEmpty()) {
    ...
    private void update() {
        ...
        if (conn != null) {
            try {
                ...
                ps.setString(1, tfUsername.getText().trim());
                if (pwd.isEmpty()) {
                    ps.setString(2, (String) cbRole.getSelectedItem());
    ...
    private void initComponents() {
        ...
        jPanelFieldUsername = new javax.swing.JPanel();
        jLabelUsername = new javax.swing.JLabel();
        tfUsername = new javax.swing.JTextField();
        jPanelFieldPassword = new javax.swing.JPanel();
        jLabelPassword = new javax.swing.JLabel();
        tfPassword = new javax.swing.JPasswordField();
        jPanelFieldRole = new javax.swing.JPanel();
        ...
        jLabelTitle.setText("👤  Manajemen User");
        ...
        jPanelFields.setLayout(new java.awt.GridLayout(1, 3, 15, 0));

        jPanelFieldUsername.setBackground(new java.awt.Color(255, 255, 255));
        jPanelFieldUsername.setLayout(new java.awt.BorderLayout(0, 4));

        jLabelUsername.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabelUsername.setText("Username :");
        jPanelFieldUsername.add(jLabelUsername, java.awt.BorderLayout.NORTH);

        tfUsername.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanelFieldUsername.add(tfUsername, java.awt.BorderLayout.CENTER);

        jPanelFields.add(jPanelFieldUsername);

        jPanelFieldPassword.setBackground(new java.awt.Color(255, 255, 255));
        jPanelFieldPassword.setLayout(new java.awt.BorderLayout(0, 4));

        jLabelPassword.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabelPassword.setText("Password :");
        jPanelFieldPassword.add(jLabelPassword, java.awt.BorderLayout.NORTH);

        tfPassword.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanelFieldPassword.add(tfPassword, java.awt.BorderLayout.CENTER);

        jPanelFields.add(jPanelFieldPassword);

        jPanelFieldRole.setBackground(new java.awt.Color(255, 255, 255));
        jPanelFieldRole.setLayout(new java.awt.BorderLayout(0, 4));

        jLabelRole.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabelRole.setText("Role :");
        jPanelFieldRole.add(jLabelRole, java.awt.BorderLayout.NORTH);

        cbRole.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jPanelFieldRole.add(cbRole, java.awt.BorderLayout.CENTER);

        jPanelFields.add(jPanelFieldRole);
    ...
    private javax.swing.JPanel jPanelFieldPassword;
    private javax.swing.JPanel jPanelFieldRole;
    private javax.swing.JPanel jPanelFieldUsername;
